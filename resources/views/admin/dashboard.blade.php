    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <div class="flex-1 p-8 space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <x-admin-metric-card title="Total Students" value="69" />
            ...
            <div class="mt-10">
                ...
                <ul class="bg-white rounded-lg shadow divide-y divide-gray-200 text-lg">
                    <li class="py-4 px-6">Juan Dela Cruz – juan@example.com</li>
                    <li class="py-4 px-6">Maria Santos – maria@example.com</li>
                    <li class="py-4 px-6">Jose Rizal – jose@example.com</li>
                </ul>
            </div>
        </div>
    </div>
